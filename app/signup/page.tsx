      ...
      <div className="flex items-center justify-center min-h-screen bg-zinc-100">
        <div className="relative w-full max-w-2xl mx-4">
          ...
          <button onClick={() => router.push('/')} className="absolute top-4 right-4 text-2xl text-violet-500 hover:text-violet-800">&times;</button>
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-3xl font-semibold text-center mb-6 text-violet-800">Create New Account</motion.h2>
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  type="email"
                  className="w-full border rounded-lg text-black px-4 py-3 focus:outline-none hover:shadow-xl hover:shadow-violet-200 transition-shadow duration-300 hover:ring-1 hover:ring-violet-500 focus:ring-2 focus:ring-violet-500"
                  placeholder="Email"
                />
              </div>
              <div>
                <label className="block text-violet-700 hover:text-violet-800 text-lg mb-2">Username</label>
                <input
                  type="text"
                  className="w-full border rounded-lg text-black px-4 py-3 hover:shadow-xl hover:shadow-violet-200 transition-shadow duration-300 hover:ring-1 hover:ring-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500"
              ...
              <div>
                ...
                <input
                  type="password"
                  className="w-full border rounded-lg px-4 text-black py-3 focus:outline-none hover:shadow-xl hover:shadow-violet-200 transition-shadow duration-300 hover:ring-1 hover:ring-violet-500 focus:ring-2 focus:ring-violet-500"
            ...
            <p className="text-center text-gray-500 text-base mt-6">
              ...
              <Link href="/signin" className="text-violet-600 hover:underline hover:text-violet-800">
                Sign in
              </Link>
            </p>
          </div>
